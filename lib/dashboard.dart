        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              price(txt: "USD 350"),
              button(txt: 'Edit', bcolor: Colors.blueAccent, tcolor: Colors.white, route: productform.id),
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              button(txt: 'Edit', bcolor: Colors.blueAccent, tcolor: Colors.white, route: Confirm.id),
              SizedBox(height: 8.0),
              button(txt: "Remove", bcolor: Colors.white, tcolor: Colors.black, route: ''),
            ],
          ),
